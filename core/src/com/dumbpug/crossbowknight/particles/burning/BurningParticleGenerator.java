...
public class BurningParticleGenerator implements IParticleGenerator, IEmitterActivity {
	 ...
	 * @param areaHeight
	 */
	public BurningParticleGenerator(LevelCamera camera, float areaWidth, float areaHeight) {
		this(camera);
	...
	public Particle generate(IEmitterDetails emitterDetails) {
		...
		// Create the particle.
		return new BurningParticle(emitterDetails.positionX() + randomPosOffsetX, emitterDetails.positionY() + randomPosOffsetY, camera);
	}
